...
public class MemberServiceImpl implements MemberService{
    ...
    /*
        의존관계 자동 주입 ComponentScan 을 쓰게 되면 Autowired 를 쓰게 된다. @Bean 으로 등록을 하지 않기 때문
        이전에 AppConfig 에서는 @Bean 으로 직접 설정 정보를 작성했고, 의존관계도 직접 명시했다. 이제는 이런 설정 정보 자체가 없기 때문에 , 의존관계 주입도 이 클래스안에서 해결해야한다.
    */
