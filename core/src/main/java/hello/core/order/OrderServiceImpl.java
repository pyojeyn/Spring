...
//    }
    ...
    */
    @Autowired
    public OrderServiceImpl(MemberRepository memberRepository, DiscountPolicy discountPolicy) { //FIX 가 들어올지, RATE가 들어올지 모할  CMD + OPTION + B => 구현체 클래스
        this.memberRepository = memberRepository;
        this.discountPolicy = discountPolicy;
    }
    ...
    * */
    ...
    // 단일책임의 원칙 잘 지켜짐 !할인데 관한 업무는 discountPolicy 가 해결해줌
    @Override
